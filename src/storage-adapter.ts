import type { KVGetOptions, KVListOptions, KVListResult, KVNamespace, KVPutOptions, KVValue, StoredRecord } from "./types";
...
export class KVStorageAdapter implements KVNamespace {
    ...
    constructor(private backend: StorageBackend, opts?: { cacheEntries?: number }) {
